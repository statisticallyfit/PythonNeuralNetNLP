...
def main():
    ...
    #testJacobianMatrixOfScalarFunctionIsGradient()
    # exp_jacobian_03()


def rosen(x: xr.DataArray) -> np.double :
    return (1 - x.x0) ** 2 + 105. * (x[1] - x[0] ** 2) ** 2
...
#
#def exp_jacobian_02():
def testJacobianMatrixOfScalarFunctionIsGradient():
