# %% markdown
# Source: [part 1](https://github.com/bentrevett/pytorch-seq2seq/blob/master/1%20-%20Sequence%20to%20Sequence
# %20Learning%20with%20Neural%20Networks.ipynb)
# %% codecell
import os
...
#
# In the [paper](https://arxiv.org/pdf/1409.3215.pdf) we are implementing, they find it beneficial to [reverse the order of the input](https://hyp.is/rM9cWAw7Eeq51Kd0PF-hXQ/arxiv.org/pdf/1409.3215.pdf) which they believe "introduces many short term dependencies in the data that make the optimization problem much easier".
# %% codecell
